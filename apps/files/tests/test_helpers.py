...
class TestFileHelper(amo.tests.TestCase):
    ...
    def test_files_not_extracted(self):
        assert self.viewer.is_extracted() == False

    def test_files_extracted(self):
        self.viewer.extract()
        assert self.viewer.is_extracted() == True
    ...
    def test_recurse_contents(self):
        ...
        for name in nm:
            assert name in files, True == 'File %r not extracted' % name
    ...
    def test_get_files_directory(self):
        self.viewer.extract()
        files = self.viewer.get_files()
        assert files['install.js']['directory'] == False
        assert files['install.js']['binary'] == False
        assert files['__MACOSX']['directory'] == True
        assert files['__MACOSX']['binary'] == False
...
class TestDiffHelper(amo.tests.TestCase):
    ...
    def test_files_not_extracted(self):
        assert self.helper.is_extracted() == False

    def test_files_extracted(self):
        self.helper.extract()
        assert self.helper.is_extracted() == True
    ...
    def test_diffable_deleted_files(self):
        ...
        assert 'install.js' in self.helper.get_deleted_files() == True
    ...
    def test_diffable_parent(self):
        ...
        assert files['__MACOSX/._dictionaries']['diff'] == True
        assert files['__MACOSX']['diff'] == True
