...
class TestBlacklistedName(amo.tests.TestCase):
    ...
    def test_blocked(self):
        assert BlacklistedName.blocked('IE6Fan') == True
        assert BlacklistedName.blocked('IE6fantastic') == True
        assert BlacklistedName.blocked('IE6') == False
        assert BlacklistedName.blocked('testo') == False
...
class TestBlacklistedEmailDomain(amo.tests.TestCase):
    ...
    def test_blocked(self):
        assert BlacklistedEmailDomain.blocked('mailinator.com') == True
...
class TestUserEmailField(amo.tests.TestCase):
    ...
    def test_empty_email(self):
        ...
        assert e.exception.messages[0] == 'This field is required.'
